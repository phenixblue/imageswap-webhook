...
imageswap_service_name = os.getenv("IMAGESWAP_SERVICE_NAME", "imageswap") # TODO: It'd be better to read the name of the service from the imageswap_mwc_template_file
